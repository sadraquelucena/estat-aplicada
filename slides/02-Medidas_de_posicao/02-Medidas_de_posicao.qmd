...
- Na Engenharia de Materiais, é comum realizarmos diversas vezes um experimento para caracterizar as propriedades de um material.
...
- Por isso, faz mais sentido olhar para o comportamento de um conjunto de corpos de prova do que para um único teste.
...
- As **Medidas de Posição** (ou de Tendência Central) são os nossos primeiros instrumentos de navegação para localizar onde a maioria dos nossos dados "se localizam".
...
- Imagine que você precisa decidir se um lote de polímero para próteses médicas deve ser aprovado ou descartado. Se você olhar apenas para a **Média**, pode ignorar uma peça defeituosa que causará a quebra da prótese. Precisamos de todas as medidas para decidir com segurança.
...
Em um laboratório, uma engenheira está avaliando a **resistência à tração** (*tensão máxima que o material suporta antes de romper*) de um polímero usado em engrenagens. Cada peça testada pode apresentar valores ligeiramente diferentes devido a:
...
> outlier = valor muito diferente dos demais dados
...
(Mesmos dados so Exemplo 1.2) Considere o lote com falha de processamento. As medidas obtidas foram: **200, 205, 198, 202, 10** MPa. Calcule a mediana e compare com a média. Qual descreve melhor a resistência do polímero "bom"?
...
Um laboratório mediu a resistência à tração (tensão máxima que o material suporta antes de romper) de 10 amostras de um polím ro, em MPa. Os valores já estão ordenados:
